  ...
  <div class="app-container">
    ...
    <div class="app-content">
      <div class="app-sidebar">
        <a href="ATHLETE.php?Li=<?php echo $_SESSION['Num_licence'] ?>" class="app-sidebar-link active">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
            <polyline points="9 22 9 12 15 12 15 22" />
          </svg>
        </a>
        <a href="ATHLETE-inscri.php?Li=<?php echo $_SESSION['Num_licence'] ?>" class="app-sidebar-link">
        ...
        <div class="projects-section-line">
          <div class="projects-status">
            ...
            <div class="item-status">
              ...
              <span class="status-type">Inscris</span>
            </div>
            <div class="item-status">
          ...
          ?>
            ...
            <div class="project-box-wrapper">
              ...
              <div class="project-box-footer">
                ...
                <?php } else{
                $inscri = $tria->prepare('SELECT NUM_TRIATHLON FROM inscription WHERE NUM_LICENCE = ? AND NUM_TRIATHLON = ?');
                $inscri->execute(array($_SESSION['Num_licence'],$tri['NUM_TRIATHLON'] ));

                $voirinscri = $inscri->fetch();
                if ($voirinscri['NUM_TRIATHLON'] == $tri['NUM_TRIATHLON']) {
                ?>
                  <div class="days-left" style="color: #413933;">
                  <i class="fas fa-check"></i> INSCRIS
                  </div>
                <?php  }else { ?>
                  <div class="days-left" style="color: #413933;">
                   <a style="color:#413933;text-decoration:none;" href="ajout-inscri.php?Num=<?php echo $tri['NUM_TRIATHLON'] ?>">Inscrivez-vous !</a>
                  </div>
                <?php }} ?>
              </div>
            </div>
